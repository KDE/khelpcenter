...
my $htdigdata = "/usr/share/susehelp/htdig";
my $htdigbin = "/usr/bin";
...
# Find help file for KDE docs
if ( $docpath =~ /^help:\/?([^\/]*)/ ) {
  my $app = $1;
  &dbg( "APP: $app" );
  $docpath = "/opt/kde3/share/doc/HTML/en/$app/index.docbook";
}
...
#
# This file has been automatically created by the SuSE help system.
...
ignore_noindex:		true
max_hop_count:		4
robotstxt_name:         susedig
compression_level:	6
template_map:           Long long $htdigdata/long.html \\
...
sub usage()
{
  print "Usage: genhtdig --indexdir <indexdir> --docpath <path> ";
